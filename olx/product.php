       ...
       <!-- blank row  -->
        ...
        <form>
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input class="form-control" placeholder="Manufacturer" type="text" name="manuf" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input class="form-control" placeholder="Item Name" type="text" name="modelName" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                     <input class="form-control" placeholder="Mobile Number" type="text" name="price" required />
                  </div>
                </div>

                <div class="form-group">
                  <label  class="control-label col-md-4" >Upload Product Images</label>
                  <div class="col-md-8">
